...
namespace MangaViewer.Foundation.Common
{
    /// <summary>
    ...
    public class LayoutAwarePage : Page
    {
        ...
        private List<Windows.UI.Xaml.Controls.Control> _layoutAwareControls;
        ...
        {
            var control = sender as Windows.UI.Xaml.Controls.Control;
            if (control == null) return;
            if (this._layoutAwareControls == null)
            {
                // Start listening to view state changes when there are controls interested in updates
                Window.Current.SizeChanged += this.WindowSizeChanged;
                this._layoutAwareControls = new List<Windows.UI.Xaml.Controls.Control>();
            }
